...
{
    /// <summary> An availability result result. </summary>
    public partial class EventsAvailabilityResult : EventsResultData
    {
        /// <summary> Initializes a new instance of EventsAvailabilityResult. </summary>
        internal EventsAvailabilityResult()
        {
            Type = new EventType("availabilityResult");
        }
        ...
        /// <param name="availabilityResult"> The availability result info. </param>
        internal EventsAvailabilityResult(string id, EventType type, long? count, DateTimeOffset? timestamp, EventsResultDataCustomDimensions customDimensions, EventsResultDataCustomMeasurements customMeasurements, EventsOperationInfo operation, EventsSessionInfo session, EventsUserInfo user, EventsCloudInfo cloud, EventsAiInfo ai, EventsApplicationInfo application, EventsClientInfo client, EventsAvailabilityResultInfo availabilityResult) : base(id, type, count, timestamp, customDimensions, customMeasurements, operation, session, user, cloud, ai, application, client)
        {
        ...
        public EventsAvailabilityResultInfo AvailabilityResult { get; }
    }
}
